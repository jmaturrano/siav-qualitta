...
require_once(dirname(__FILE__).'/CanvasFactory.php');
require_once(dirname(__FILE__).'/FontMetrics.php');
require_once(dirname(__FILE__).'/Frame.php');
require_once(dirname(__FILE__).'/Helpers.php');
require_once(dirname(__FILE__).'/Renderer.php');
require_once(dirname(__FILE__).'/Adapter/CPDF.php');
require_once(dirname(__FILE__).'/Css/Stylesheet.php');
require_once(dirname(__FILE__).'/Frame/Factory.php');
require_once(dirname(__FILE__).'/Frame/FrameTree.php');
require_once(dirname(__FILE__).'/Image/Cache.php');
