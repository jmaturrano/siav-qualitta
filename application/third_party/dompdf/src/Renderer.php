...
require_once(dirname(__FILE__).'/Renderer/AbstractRenderer.php');
require_once(dirname(__FILE__).'/Renderer/Block.php');
require_once(dirname(__FILE__).'/Renderer/Image.php');
require_once(dirname(__FILE__).'/Renderer/TableCell.php');
require_once(dirname(__FILE__).'/Renderer/TableRowGroup.php');
require_once(dirname(__FILE__).'/Renderer/Text.php');
