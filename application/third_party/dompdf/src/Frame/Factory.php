...
require_once(dirname(__FILE__).'/../FrameDecorator/Block.php');
require_once(dirname(__FILE__).'/../FrameDecorator/Image.php');
require_once(dirname(__FILE__).'/../FrameDecorator/Inline.php');
require_once(dirname(__FILE__).'/../FrameDecorator/Page.php');
require_once(dirname(__FILE__).'/../FrameDecorator/Table.php');
require_once(dirname(__FILE__).'/../FrameDecorator/TableCell.php');
require_once(dirname(__FILE__).'/../FrameDecorator/TableRow.php');
require_once(dirname(__FILE__).'/../FrameDecorator/TableRowGroup.php');
require_once(dirname(__FILE__).'/../FrameDecorator/Text.php');
require_once(dirname(__FILE__).'/../FrameReflower/Block.php');
require_once(dirname(__FILE__).'/../FrameReflower/Image.php');
require_once(dirname(__FILE__).'/../FrameReflower/Inline.php');
require_once(dirname(__FILE__).'/../FrameReflower/Page.php');
require_once(dirname(__FILE__).'/../FrameReflower/Table.php');
require_once(dirname(__FILE__).'/../FrameReflower/TableCell.php');
require_once(dirname(__FILE__).'/../FrameReflower/TableRow.php');
require_once(dirname(__FILE__).'/../FrameReflower/TableRowGroup.php');
require_once(dirname(__FILE__).'/../FrameReflower/Text.php');
require_once(dirname(__FILE__).'/../Positioner/Absolute.php');
require_once(dirname(__FILE__).'/../Positioner/AbstractPositioner.php');
require_once(dirname(__FILE__).'/../Positioner/Block.php');
require_once(dirname(__FILE__).'/../Positioner/Inline.php');
require_once(dirname(__FILE__).'/../Positioner/NullPositioner.php');
require_once(dirname(__FILE__).'/../Positioner/TableCell.php');
