	      		...
	      		<div class="widget">
					...
					<div class="widget-content">
						<div id="formsearch" class="">
							...
							$ruta = 'registros/departamento/buscar';
				                	...
				                	if(isset($data_depa)){
				               		...
				               		?>
										<tr>
											...
											<td class="texto-centrado"><?= $departamento->depa_codigo; ?></td>
											<td class=""><?= $departamento->depa_descripcion; ?></td>
											<td class="texto-centrado"><?= date('d/m/Y', strtotime($departamento->depa_fecha_registro)); ?></td>
											<td class="texto-centrado td-actions">
						                    	<a title="Ver" class="btn btn-small btn-info btn_consulta" href="<?= base_url('registros/departamento/ver/'.str_encrypt($departamento->depa_id, KEY_ENCRYPT)); ?>">
						                    		<i class="btn-icon-only <?= ICON_VIEW; ?>"> </i>
						                    	</a>
						                    	<a title="Editar" class="btn btn-small btn-invert btn_editar" href="<?= base_url('registros/departamento/editar/'.str_encrypt($departamento->depa_id, KEY_ENCRYPT)); ?>">
						                    		<i class="btn-icon-only <?= ICON_EDIT; ?>"> </i>
						                    	</a>
						                    	<a title="Eliminar" class="btn btn-small btn-danger tr_delete" href="javascript:;" data-url="<?= base_url('registros/departamento/eliminar/'.str_encrypt($departamento->depa_id, KEY_ENCRYPT)); ?>">
