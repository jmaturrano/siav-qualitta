	      		...
	      		<div class="widget">
					...
					<div class="widget-content">
						<div id="formsearch" class="">
							...
							$ruta = 'registros/provincia/buscar/'.(str_encrypt($depa_id, KEY_ENCRYPT));
				               		...
				               		?>
										<tr>
											...
											<td class="texto-centrado td-actions">
						                    	<a title="Ver" class="btn btn-small btn-info btn_consulta" href="<?= base_url('registros/provincia/ver/'.str_encrypt($provincia->prov_id, KEY_ENCRYPT)); ?>">
						                    		<i class="btn-icon-only <?= ICON_VIEW; ?>"> </i>
						                    	</a>
						                    	<a title="Editar" class="btn btn-small btn-invert btn_editar" href="<?= base_url('registros/provincia/editar/'.str_encrypt($provincia->prov_id, KEY_ENCRYPT)); ?>">
						                    		<i class="btn-icon-only <?= ICON_EDIT; ?>"> </i>
						                    	</a>
						                    	<a title="Eliminar" class="btn btn-small btn-danger tr_delete" href="javascript:;" data-url="<?= base_url('registros/provincia/eliminar/'.str_encrypt($provincia->prov_id, KEY_ENCRYPT)); ?>">
