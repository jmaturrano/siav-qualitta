...
<link href="<?php echo base_url('public/assets/themes/bt-admin-tpl2013/css/pages/dashboard.css') ?>" rel="stylesheet">

<?php
  if(!isset($ROLES)){
    echo '<script>';
    echo 'bootbox.alert("<span class=\"glyphicon glyphicon-exclamation-sign\"></span> Lo sentimos. Usted no tiene un rol asignado para esta oficina.");';
    echo '</script>';
  }
?>
          ...
          <div class="widget">
            ...
            <div class="widget-content">
              <ul class="messages_layout">
                <li class="from_user left"> <a href="#" class="avatar"><img src=""/></a>
                ...
                <li class="by_myself right"> <a href="#" class="avatar"><img src=""/></a>
                  <div class="message_wrap"> <span class="arrow"></span>
...
<script src="<?= base_url('public/assets/themes/bt-admin-tpl2013/js/excanvas.min.js'); ?>"></script> 
<script src="<?= base_url('public/assets/themes/bt-admin-tpl2013/js/chart.min.js'); ?>" type="text/javascript"></script>
<script language="javascript" type="text/javascript" src="<?= base_url('public/assets/themes/bt-admin-tpl2013/js/full-calendar/fullcalendar.min.js'); ?>"></script>
 
<script src="<?= base_url('public/assets/themes/bt-admin-tpl2013/js/base.js'); ?>"></script> 
<script>
